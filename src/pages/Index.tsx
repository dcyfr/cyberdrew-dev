...
const Index = () => {
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-32 h-32 bg-accent-blue/10 rounded-full blur-xl animate-glow"></div>
      <div className="absolute bottom-20 right-10 w-48 h-48 bg-accent-green/10 rounded-full blur-xl animate-glow" style={{animationDelay: '1s'}}></div>
      ...
      <div className="relative flex items-center justify-center min-h-screen">
        <div className="text-center max-w-4xl mx-auto px-6">
          ...
          {/* CTA Buttons */}
          <div className="animate-slide-up flex flex-col sm:flex-row gap-4 justify-center mb-16" style={{animationDelay: '0.6s', animationFillMode: 'both'}}>
          ...
          {/* Social Links */}
          <div className="animate-slide-up flex justify-center gap-6" style={{animationDelay: '0.9s', animationFillMode: 'both'}}>
            <a 
