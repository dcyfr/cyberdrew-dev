...
const Home = () => {
  ...
  return <>
      <SEOHead title="Drew's Lab - Cybersecurity Expert & Developer" description="Cybersecurity expert specializing in security architecture, threat analysis, and secure development practices. Explore insights on zero-trust, MFA, and enterprise security." keywords="cybersecurity, security architecture, threat analysis, zero trust, MFA, enterprise security, security consultant" />
      <PageTransition>
          ...
          <div className="container mx-auto px-6 py-16 max-w-4xl">
            ...
            <div className="flex flex-col items-center text-center mb-20">
              <div className="mb-8 rounded-xl border border-border/30 hover:border-border/60 p-2 hover:shadow-[0_4px_20px_rgb(0,0,0,0.05)] dark:hover:shadow-[0_4px_20px_rgb(0,0,0,0.2)] transition-all duration-300 hover:-translate-y-1 bg-card/40 backdrop-blur-sm">
                <img src={drewProfile} alt="Drew" className="w-24 h-24 rounded-lg object-cover" />
              </div>
              
              <h1 className="text-4xl font-bold text-foreground mb-4 leading-tight">It's Drew ✨</h1>
              
              <p className="text-lg text-muted-foreground mb-8 max-w-md leading-relaxed">Cyber Architecture, Engineering, and Development</p>
              ...
              <div className="flex gap-3">
                ...
                <Button variant="outline" onClick={() => navigate("/resume")} className="hover:scale-105 transition-transform duration-200">
            ...
            <div className="text-center mt-20">
              <Button variant="default" onClick={() => window.open("https://github.com/sponsors/dcyfr", "_blank")} className="hover:scale-105 transition-transform duration-200">
